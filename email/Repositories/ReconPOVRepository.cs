        ...
        public async Task<List<ReconciliationDetail3>> GetAllForMatching()
{
    ...
    var sql = @"SELECT 
        ...
        item_name_transfer AS ItemNameTransfer,
        ...
        sender_site_received AS SenderSiteReceived,
        receive_site_received AS ReceiveSiteReceived,
        item_name_received AS ItemNameReceived,
        unit_cogs_received AS UnitCOGSReceived,
