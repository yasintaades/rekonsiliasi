...
namespace Reconciliation.Api.Controllers
{
    ...
    public class ReconController : ControllerBase
    {
        ...
        /// <summary>
        /// Endpoint untuk mengolah data rekonsiliasi.
        /// Mengambil data Cegid dari folder Downloads berdasarkan logId (SFTP),
        /// dan membandingkannya dengan file Anchanto yang diupload manual.
        /// </summary>
        ...
        /// <summary>
        /// Endpoint untuk mengambil detail rekonsiliasi yang sudah tersimpan berdasarkan ID.
        /// Digunakan untuk preview data lama atau setelah proses upload berhasil.
        /// </summary>
        ...
        /// <summary>
        /// Endpoint opsional untuk upload 2 file manual (tanpa SFTP) jika dibutuhkan.
        /// </summary>
        [HttpPost("upload-2")]
...
// Tambahkan fungsi ini di dalam ReconController.cs
