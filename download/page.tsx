...
interface Detail {
  refNo: string;
  anchantoSKU: number | null;
  anchantoDate: string | null;
  cegidSKU: number | null;
      ...
      <div className="w-full max-w-6xl">
        ...
        {result && (
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-6">
            ...
            <div onClick={() => handleFilter("AMOUNT_MISMATCH")} className="bg-yellow-50 p-4 rounded cursor-pointer hover:bg-yellow-100">
